...
const router = new Router({
  ...
  routes: [
    ...
    { path: '/list-property', name: 'ListProperty', component: ListProperty },
    { path: '/login', name: 'Login', component: LoginPage },
    { path: '/register', name: 'Register', component: UserPage },
    { path: '/searchresults', name: 'SearchResults', component: SearchResultsPage },
    { path: '/dashboard', name: 'Dashboard', component: DashBoard, meta: { requiresAuth: true } },
    { path: '/spot/:id', name: 'SpotProfile', component: SpotProfile },
    { path: '/camping-spot/:id', name: 'viewCampingSpot', component: ViewCampingSpot, props: true },
    { path: '/camping-spot/:id/edit', name: 'editCampingSpot', component: SingularCampingSpot, props: true },
